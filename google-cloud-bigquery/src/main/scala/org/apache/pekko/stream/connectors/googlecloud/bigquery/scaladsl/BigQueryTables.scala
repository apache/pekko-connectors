...
import org.apache.pekko.stream.connectors.googlecloud.bigquery.model.{ Table, TableListResponse, TableReference }
...
private[scaladsl] trait BigQueryTables { this: BigQueryRest =>
   ...
   * @return a [[org.apache.pekko.stream.scaladsl.Source]] that emits each [[org.apache.pekko.stream.connectors.googlecloud.bigquery.model.Table]] in the dataset and materializes a [[scala.concurrent.Future]] containing the [[org.apache.pekko.stream.connectors.googlecloud.bigquery.model.TableListResponse]]
   */
   ...
   * @return a [[scala.concurrent.Future]] containing the [[org.apache.pekko.stream.connectors.googlecloud.bigquery.model.Table]]
   */
