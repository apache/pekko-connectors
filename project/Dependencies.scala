...
object Dependencies {
  ...
  val protobufJavaVersion = "3.25.7"
  ...
  val GoogleBigQueryStorage = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.api.grpc" % "proto-google-cloud-bigquerystorage-v1" % "3.14.1" % "protobuf-src",
  ...
  val GooglePubSubGrpc = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.cloud" % "google-cloud-pubsub" % "1.139.4" % "protobuf-src",
      "io.grpc" % "grpc-auth" % org.apache.pekko.grpc.gen.BuildInfo.grpcVersion,
