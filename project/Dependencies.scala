...
object Dependencies {
  ...
  val mockitoVersion = "5.24.0" // check even https://github.com/scalatest/scalatestplus-mockito/releases
  ...
  val GoogleBigQueryStorage = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.api.grpc" % "proto-google-cloud-bigquerystorage-v1" % "3.34.0" % "protobuf-src",
  ...
  val GooglePubSubGrpc = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.cloud" % "google-cloud-pubsub" % "1.156.0" % "protobuf-src",
      "io.grpc" % "grpc-auth" % org.apache.pekko.grpc.gen.BuildInfo.grpcVersion,
      "com.google.auth" % "google-auth-library-oauth2-http" % GoogleAuthVersion,
      "com.google.protobuf" % "protobuf-java" % protobufJavaVersion % Runtime,
  ...
  val Kinesis = Seq(
    libraryDependencies ++= Seq(
      ...
      "software.amazon.kinesis" % "amazon-kinesis-client" % "3.5.3").map(
      _.excludeAll(
        ExclusionRule("software.amazon.awssdk", "apache-client"),
        ExclusionRule("software.amazon.awssdk", "netty-nio-client"),
