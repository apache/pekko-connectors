...
object Dependencies {
  ...
  val GoogleBigQueryStorage = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.api.grpc" % "proto-google-cloud-bigquerystorage-v1" % "3.11.1" % "protobuf-src",
  ...
  val GooglePubSubGrpc = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.cloud" % "google-cloud-pubsub" % "1.136.0" % "protobuf-src",
      "io.grpc" % "grpc-auth" % org.apache.pekko.grpc.gen.BuildInfo.grpcVersion,
