...
object Dependencies {
  ...
  val GoogleBigQueryStorage = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.api.grpc" % "proto-google-cloud-bigquerystorage-v1" % "3.16.1" % "protobuf-src",
  ...
  val GooglePubSubGrpc = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.cloud" % "google-cloud-pubsub" % "1.141.1" % "protobuf-src",
      "io.grpc" % "grpc-auth" % org.apache.pekko.grpc.gen.BuildInfo.grpcVersion,
  ...
  val JakartaMs = {
    ...
    Seq(
      libraryDependencies ++= Seq(
        ...
        "com.ibm.mq" % "com.ibm.mq.jakarta.client" % "9.4.3.0" % Test,
  ...
  val Jms = Seq(
    libraryDependencies ++= Seq(
      ...
      "com.ibm.mq" % "com.ibm.mq.allclient" % "9.4.3.0" % Test,
  ...
  val Kinesis = Seq(
    libraryDependencies ++= Seq(
      ...
      "software.amazon.kinesis" % "amazon-kinesis-client" % "3.1.1").map(
      _.excludeAll(
        ExclusionRule("software.amazon.awssdk", "apache-client"),
  ...
  val OrientDB = Seq(
    libraryDependencies ++= JacksonDatabindDependencies ++ Seq(
      ...
      "com.orientechnologies" % "orientdb-object" % "3.2.43"))
