...
object Dependencies {
  ...
  val GoogleBigQueryStorage = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.api.grpc" % "proto-google-cloud-bigquerystorage-v1" % "3.30.0" % "protobuf-src",
  ...
  val Jms = Seq(
    libraryDependencies ++= Seq(
      ...
      "org.apache.activemq" % "activemq-broker" % "5.19.8" % Test,
      "org.apache.activemq" % "activemq-client" % "5.19.8" % Test,
