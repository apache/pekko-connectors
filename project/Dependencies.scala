...
object Dependencies {
  ...
  val mockitoVersion = "5.10.0" // check even https://github.com/scalatest/scalatestplus-mockito/releases
  ...
  val GoogleBigQueryStorage = Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.google.api.grpc" % "proto-google-cloud-bigquerystorage-v1" % "1.22.8" % "protobuf-src",
