...
private[couchbase] final class CouchbaseSessionScalaAdapter(delegate: javadsl.CouchbaseSession)
  ...
  override def asJava: CouchbaseSession = delegate
   ...
   */
  override def insert(id: String, document: Object, insertOptions: InsertOptions): Future[MutationResult] =
   ...
   * @return A document if found or none if there is no document for the id
   */
  override def get[T](id: String, documentClass: Class[T], getOptions: GetOptions): Future[T] =
   ...
   */
  override def upsert[T](id: String, document: T, upsertOptions: UpsertOptions): Future[MutationResult] =
   ...
   */
  override def replace[T](id: String, document: T, replaceOptions: ReplaceOptions): Future[MutationResult] =
   ...
   */
  override def remove(id: String, removeOptions: RemoveOptions): Future[MutationResult] =
   ...
   */
  override def counter(id: String, incrementOptions: IncrementOptions): Future[CounterResult] =
