...
object HmsSettings {
  ...
  val ConfigPath = "pekko.connectors.huawei.pushkit"
  ...
  /**
   * Scala API: Creates [[HmsSettings]] from the [[com.typesafe.config.Config Config]] attached to an [[org.apache.pekko.actor.ActorSystem]].
   */
