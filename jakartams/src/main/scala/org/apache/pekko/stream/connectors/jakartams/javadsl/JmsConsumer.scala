...
object JmsConsumer {
  ...
  def create(settings: JmsConsumerSettings): pekko.stream.javadsl.Source[Message, JmsConsumerControl] =
    pekko.stream.connectors.jakartams.scaladsl.JmsConsumer.apply(settings).mapMaterializedValue(
  ...
  def textSource(settings: JmsConsumerSettings): pekko.stream.javadsl.Source[String, JmsConsumerControl] =
    pekko.stream.connectors.jakartams.scaladsl.JmsConsumer.textSource(settings).mapMaterializedValue(
      toConsumerControl).asJava
  ...
  def bytesSource(
    ...
    pekko.stream.connectors.jakartams.scaladsl.JmsConsumer.bytesSource(settings).mapMaterializedValue(
      toConsumerControl).asJava
  ...
  def mapSource(
    ...
    pekko.stream.connectors.jakartams.scaladsl.JmsConsumer
      .mapSource(settings)
      .map(_.asJava)
  ...
  def objectSource(
    ...
    pekko.stream.connectors.jakartams.scaladsl.JmsConsumer.objectSource(settings).mapMaterializedValue(
      toConsumerControl).asJava
  ...
  def ackSource(
    ...
    pekko.stream.connectors.jakartams.scaladsl.JmsConsumer.ackSource(settings).mapMaterializedValue(
      toConsumerControl).asJava
  ...
  def txSource(settings: JmsConsumerSettings): pekko.stream.javadsl.Source[TxEnvelope, JmsConsumerControl] =
    pekko.stream.connectors.jakartams.scaladsl.JmsConsumer.txSource(settings).mapMaterializedValue(
      toConsumerControl).asJava
  ...
  def browse(settings: JmsBrowseSettings): pekko.stream.javadsl.Source[Message, NotUsed] =
    pekko.stream.connectors.jakartams.scaladsl.JmsConsumer.browse(settings).asJava
