 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsByteMessagePassThrough[+PassThrough] protected[jakartams] (val bytes: Array[Byte],
    val headers: Set[JmsHeader] = Set.empty,
    val properties: Map[String, Any] = Map.empty,
    val destination: Option[Destination] = None,
 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsByteStringMessagePassThrough[+PassThrough] protected[jakartams] (val bytes: ByteString,
    val headers: Set[JmsHeader] = Set.empty,
    val properties: Map[String, Any] = Map.empty,
    val destination: Option[Destination] = None,
    val passThrough: PassThrough)
 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsMapMessagePassThrough[+PassThrough] protected[jakartams] (val body: Map[String, Any],
    val headers: Set[JmsHeader] = Set.empty,
    val properties: Map[String, Any] = Map.empty,
    val destination: Option[Destination] = None,
    val passThrough: PassThrough)
 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsTextMessagePassThrough[+PassThrough] protected[jakartams] (val body: String,
    val headers: Set[JmsHeader] = Set.empty,
    val properties: Map[String, Any] = Map.empty,
    val destination: Option[Destination] = None,
    val passThrough: PassThrough)
 ...
 * @tparam PassThrough the type of data passed through the `flexiFlow`
 */
sealed class JmsObjectMessagePassThrough[+PassThrough] protected[jakartams] (val serializable: java.io.Serializable,
    val headers: Set[JmsHeader] = Set.empty,
    val properties: Map[String, Any] = Map.empty,
    val destination: Option[Destination] = None,
    val passThrough: PassThrough)
