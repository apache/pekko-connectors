...
object HdfsFlow {
  ...
  def data(
      ...
      settings: HdfsWritingSettings): Flow[HdfsWriteMessage[ByteString, NotUsed], RotationMessage, NotUsed] =
  ...
  def dataWithPassThrough[P](
      ...
      syncStrategy: SyncStrategy,
      rotationStrategy: RotationStrategy,
      settings: HdfsWritingSettings): Flow[HdfsWriteMessage[ByteString, P], OutgoingMessage[P], NotUsed] =
    Flow
      .fromGraph(
  ...
  def sequence[K <: Writable, V <: Writable](
      ...
      classK: Class[K],
      classV: Class[V]): Flow[HdfsWriteMessage[(K, V), NotUsed], RotationMessage, NotUsed] =
  ...
  def sequence[K <: Writable, V <: Writable](
    ...
    sequenceWithPassThrough[K, V, NotUsed](
      ...
      settings,
      classK,
      classV).collect(OnlyRotationMessage)
  ...
  def sequenceWithPassThrough[K <: Writable, V <: Writable, P](
      ...
      settings: HdfsWritingSettings,
      classK: Class[K],
      classV: Class[V]): Flow[HdfsWriteMessage[(K, V), P], OutgoingMessage[P], NotUsed] =
    Flow
      .fromGraph(
